...
@IBDesignable open class ColorWell: UIButton {
    ...
    override open func draw(_ rect: CGRect) {
        ...
        if let col = previewColor {
            ...
            ovalPath.addArc(withCenter: CGPoint(x: ovalRect.midX, y: ovalRect.midY), radius: ovalRect.width / 2, startAngle: -90 * CGFloat(M_PI)/180, endAngle: 90 * CGFloat(Double.pi)/180, clockwise: true)
